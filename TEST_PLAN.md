# Ditto — Merged Test Plan

Merge of the two reviewer test plans, deduplicated and prioritized. Current state: **44 tests pass** (`swift test` → "Executed 44 tests, with 0 failures") across `DittoTests.swift` and `DeepSearchTests.swift`.
...
- **File:** shared `Tests/DittoTests/TestSupport.swift`.
...
- **File:** `Tests/DittoTests/OgmaTokenizerTests.swift` (new) + checked-in `tokenizer.json` fixture.
...
- **File:** `Tests/DittoTests/DatabaseTests.swift` (new).
...
- **File:** `Tests/DittoTests/MigrationTests.swift` (new).
...
- **File:** `Tests/DittoTests/EmbeddingFailureTests.swift` (new). *(Requires the BL-05 change to make failures observable.)*
...
- **File:** `Tests/DittoTests/DatabaseTests.swift`. *(Requires BL-06.)*
...
- **File:** `Tests/DittoTests/ReclassifyTests.swift` (new).
...
- **File:** `Tests/DittoTests/DeepSearchTests.swift` (add stub + test).
...
- **File:** `Tests/DittoTests/SearchRankingTests.swift` (new).
...
- **File:** `Tests/DittoTests/RefineKindTests.swift` (new).
...
- **File:** `Tests/DittoTests/CaptureTests.swift` (new) + pasteboard seam.
...
- **File:** `Tests/DittoTests/ReindexConcurrencyTests.swift` (new).
...
- **File:** `Tests/DittoTests/PayloadTests.swift` (new). *(After BL-18.)*
