...
- **File:** `Sources/Yank/Search/DeepSearch.swift:170` (`model.prediction`), `262-271` (`ClipIndexer.index`), `241` (`TagSpace.vectors`); call sites `Sources/Yank/Clipboard/ClipStore.swift:70-73` (`add()`), `Sources/Yank/UI/PanelViewModel.swift:61,65`.
...
- **File:** `Sources/Yank/Clipboard/ClipStore.swift:107` (`reindexStale`), `139` (`reclassifyAllTags`).
...
- **File:** `Sources/Yank/Search/OgmaTokenizer.swift:54,71,72` (encode/normalize).
...
- **File:** `Sources/Yank/UI/ContentView.swift:57`; `Sources/Yank/App/AppDelegate.swift:163-182`.
...
- **File:** `Sources/Yank/Clipboard/Database.swift:13-35`; `Sources/Yank/Clipboard/ClipStore.swift:41-48`; no `.entitlements`.
...
- **File:** `Sources/Yank/Clipboard/ClipboardMonitor.swift:64-72`.
...
- **File:** `Sources/Yank/Clipboard/ClipStore.swift:74-80, 87-94, 228-233`.
...
- **File:** `Sources/Yank/UI/ClipCardView.swift:74-81`; `Sources/Yank/Clipboard/ClipboardMonitor.swift:113-120` (persist).
...
- **File:** `Sources/Yank/UI/PanelViewModel.swift:46-67, 73-121`; `Sources/Yank/UI/ContentView.swift:125,158,240`; `Sources/Yank/Search/DeepSearch.swift:310-321,302-307`.
...
- **File:** `Sources/Yank/Search/DeepSearch.swift:154-185, 266-276`; `Sources/Yank/Clipboard/ClipItem.swift:76`.
...
- **File:** `Sources/Yank/Clipboard/Database.swift:109,122,132,138,149-151,155-166`; `Sources/Yank/Clipboard/ClipStore.swift:59-81,169-196`.
...
- **Impact:** A wide (non-technical) userbase has no way to obtain a runnable Yank. The target persona for a menu-bar clipboard manager (compare Paste's notarized `.dmg`) cannot install from source.
...
- **File:** `Sources/Yank/Clipboard/ClipStore.swift:109,127,141,161`; `Sources/Yank/Clipboard/ClipboardMonitor.swift:29-37`.
...
- **File:** `Sources/Yank/Clipboard/ClipStore.swift:113/131, 146/165`; triggers in `SettingsView.swift:27,33,45`, `AppDelegate.swift:30`.
...
- **File:** `Sources/Yank/Search/OgmaTokenizer.swift:11`.
...
- **File:** `Sources/Yank/Search/DeepSearch.swift:32,201-207`.
...
- **File:** `Sources/Yank/Search/OgmaTokenizer.swift:63-73`.
...
- **File:** `Sources/Yank/Search/DeepSearch.swift:241,256,268-269`.
...
- **File:** `Sources/Yank/Clipboard/Database.swift:204-211`.
...
- **File:** `Sources/Yank/Clipboard/Database.swift:89-112`.
...
- **File:** `Sources/Yank/Clipboard/Database.swift:8-10,37`.
...
*(Robustness #5.)*
- **File:** `Sources/Yank/Clipboard/ClipboardMonitor.swift:113-120,93-99`; `Sources/Yank/Clipboard/ClipStore.swift:235-239`; `Sources/Yank/Clipboard/Paster.swift:19-23`.
...
- **File:** `Sources/Yank/UI/ClipCardView.swift` (whole file); `Sources/Yank/UI/ContentView.swift` (whole file).
...
- **Global Darwin notifications let any local process control the app** — `Sources/Yank/App/AppDelegate.swift:40-59`. Observers for `ai.axiotic.ditto.toggle/.embedtest/.opensettings` on the unauthenticated Darwin notify bus; no data exfil. **Rec:** gate `embedtest`/`opensettings` behind `#if DEBUG`; the hotkey toggle does not need a world-postable name.
